<?php
	...
	if($sn != null){
		...
		$r = curl_POST('search_one_equip', "sn=$sn", $logger, $endPoint);
		...
		try {
			...
			if($res->affected_rows != 1){
				...
				handleAPIResponse(200, "Success", buildPayload(['sn' => $sn]), 'api/modify_equipment', $time_start);
			...
			handle_logger('log_API_error', $logger, $mse->getCode(), 'MSE: '.$mse->getMessage(), 'None taken', $endPoint, $time_start);
			exit();
		} catch (Exception $e){
